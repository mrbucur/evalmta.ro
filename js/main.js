...
$(window).load(function () {
  ...
  var ascensor = $('#ascensorBuilding').ascensor({
    height: '100%',
    ascensorFloorName: ['acasa', 'despre', 'standarde', 'evaluari', 'contact'],
    direction: [
      [0, 1],
      [0, 2],
      [0, 3],
  ...
  $('.links-to-floor li a:eq(' + ascensor.data('current-floor') + ')').addClass(
    'selected'
  );
...
$(document).ready(function () {
  ...
  if ($('#map').length) {
    ...
    var infowindow = new google.maps.InfoWindow({
      content:
        '<b>ALBERTO RECOBA</b><br/>2550 Santa Monica Boulevard<br/> Los Angeles', //add your address
    });
